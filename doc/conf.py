"""synced_collections documentation build configuration file.
...
htmlhelp_basename = "synced_collectionsdoc"
...
latex_documents = [
    (
        master_doc,
        "synced_collections.tex",
        "synced_collections Documentation",
        "Vyas Ramasubramani",
        "manual",
    ),
]
...
man_pages = [
    (master_doc, "synced_collections", "synced_collections Documentation", [author], 1)
]
...
texinfo_documents = [
    (
        ...
        author,
        "synced_collections",
        "Pythonic abstractions over key-value stores",
        "Miscellaneous",
    ),
]
