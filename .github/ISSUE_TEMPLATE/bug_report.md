...
Please complete the following information:
 ...
 - Version of synced_collections [e.g. 1.0]:

Or copy & paste the output of: `python -c 'import platform; print(platform.platform()); import sys; print(sys.version); import synced_collections; print(synced_collections.__version__)'`
